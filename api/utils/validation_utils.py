...
class CreateDatasetReq(Base):
    ...
    def validate_chunk_method(cls, v: Any, handler) -> Any:
        ...
        allowed = {"naive", "custom", "custom_paragraph", "book", "email", "laws", "manual", "one", "paper", "picture", "presentation", "qa", "table", "tag"}
        error_msg = "Input should be 'naive', 'custom', 'custom_paragraph', 'book', 'email', 'laws', 'manual', 'one', 'paper', 'picture', 'presentation', 'qa', 'table' or 'tag'"
